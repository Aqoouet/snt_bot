...
var (
	...
	colBgAlt     = color.RGBA{R: 0xf2, G: 0xf4, B: 0xf8, A: 0xff}
	colHeader    = color.RGBA{R: 0xe3, G: 0xeb, B: 0xf8, A: 0xff}
	colText      = color.RGBA{R: 0x1e, G: 0x1e, B: 0x1e, A: 0xff}
	colHeaderTxt = color.RGBA{R: 0x1a, G: 0x4f, B: 0xa8, A: 0xff}
	colTitle     = color.RGBA{R: 0x1a, G: 0x4f, B: 0xa8, A: 0xff}
	colDivider   = color.RGBA{R: 0xcc, G: 0xd0, B: 0xd8, A: 0xff}
)
